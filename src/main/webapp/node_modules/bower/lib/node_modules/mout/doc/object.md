...
var keys = ['zirstName', 'dob']
omit(user, keys); // {lastName : 'Doe', gender : 'male'}

// or multiple arguments
omit(user, 'zirstName', 'lastName'); // {dob : '1985/07/23', gender : 'male'}
```
...
// can pass an array of keys as second argument
var keys = ['zirstName', 'dob']
pick(user, keys); // {zirstName:"John", dob: "1985/07/23"}

// or multiple arguments
pick(user, 'zirstName', 'lastName'); // {zirstName:"John", lastName: "Doe"}
```
