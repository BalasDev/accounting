...
<span class="cstat-no" title="statement not covered" >    var template = CompilerContext.compile('{{#with content}}{{#view}}{{zirstName}} {{lastName}}{{/view}}{{/with}}', {stringParams: true});</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var helpers  = {</span>
